...
const publicNavigationLinks = computed(() => [
    { label: 'Overview', href: '#restaurant-overview' },
    { label: 'Menu preview', href: '#menu-preview' },
    { label: 'All kitchens', href: route('restaurants.index') },
    ...
    <div class="relative overflow-hidden text-slate-900">
        ...
        <div class="relative mx-auto min-h-screen max-w-7xl px-6 py-8 lg:px-8">
            <PublicSiteHeader
                ...
                helper-text="Compare the kitchen, preview the menu, and add dishes before checkout."
            />

            <main class="space-y-8 pb-12 pt-6">
                <section id="restaurant-overview" class="scroll-mt-32 overflow-hidden rounded-[32px] border border-white/80 bg-[linear-gradient(135deg,#ffffff_0%,#fff8f1_58%,#f3fbfb_100%)] p-6 shadow-[0_34px_85px_-56px_rgba(11,77,89,0.6)] sm:p-8">
                ...
                <section v-if="restaurant.menuItems.length" id="menu-preview" class="scroll-mt-32 space-y-4">
